...
//MAIS UMA CONSTANTE
  ...
  function onLogin(){
    if ((username=='user01' || username=='user01@email.com')&&(password=='123'))
        navigation.navigate('PermissoesCliente')
    else
        alert("Não permitido")    
  }
  ...
  return (      
      <View style={Style.Container}>
        ...
        <Text style={Style.FontText04}>Não possui uma conta?</Text> 
        <TouchableOpacity onPress={() => navigation.navigate('PerfilCliente')}>
        <Text style={Style.FontText05}>Cadastre-se.</Text></TouchableOpacity>
        </View>
